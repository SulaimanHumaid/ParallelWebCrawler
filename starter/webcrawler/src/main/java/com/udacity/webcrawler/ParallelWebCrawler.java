...
final class ParallelWebCrawler implements WebCrawler {
    ...
    public CrawlResult crawl(List<String> startingUrls) {
        ...
        for (String url : startingUrls) {
            pool.invoke(new crawlInternal(url, maxDepth, counts, visitedUrls));
        }
    ...
    public class crawlInternal extends RecursiveAction {
        ...
        crawlInternal(String url, int maxDepth, Map<String, Integer> counts, Set<String> visitedUrls) {
            this.url = url;
            this.maxDepth = maxDepth;
            this.counts = counts;
...
//            visitedUrls.add(url);
            ...
            for (String link : result.getLinks()) {
                pool.invoke(new crawlInternal(link, maxDepth - 1, counts, visitedUrls));
            }
        }
    }
}
